...
public class Sprite {
   ...
   final static Hashtable<String, Image> ht = new Hashtable<>();
   ...
   final static String[] personKeyWords = {
   ...
   final static Hashtable<String, Integer> maxLoopStatus = new Hashtable<>();
   ...
   public String[] getPersonColors() {
      return personColors;
   }

   public Hashtable<String, Image> getHt() {
      return ht;
   }

   public Hashtable<String, Integer> getMaxLoopStatus() {
      return maxLoopStatus;
   }
}
