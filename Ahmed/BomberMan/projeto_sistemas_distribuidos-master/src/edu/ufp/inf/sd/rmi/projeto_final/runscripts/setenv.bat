...
@Set WORKDRIVE=C
@Set JDK=C:\\Users\\Miguel\\.jdks\\corretto-1.8.0_402
...
@set JAVAPROJ=C:\\Users\\Miguel\\Documents\\JavaProjects\\SD
@Set PACKAGE=projeto_final
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=BombermanService
@Set CLIENT_CLASS_PREFIX=Bomberman
@Set SERVER_CLASS_PREFIX=Bomberman
...
@REM Modifiquei a linha abaixo para adicionar as bibliotecas JJW ao CLASSPATH
@set CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%;%JAVAPROJ%\lib\jjwt-api-0.11.2.jar;%JAVAPROJ%\lib\jjwt-impl-0.11.2.jar;%JAVAPROJ%\lib\jjwt-jackson-0.11.2.jar;%JAVAPROJ%\lib\jackson-core-2.12.3.jar;%JAVAPROJ%\lib\jackson-databind-2.12.3.jar;%JAVAPROJ%\lib\jackson-annotations-2.12.3.jar
